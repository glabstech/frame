	...
	*/
	...
	function initialize() {
		...
		$this->settings = array(
			...
			// urls
			'file'				=> __FILE__,
			'basename'			=> '/admin/lib/advanced-custom-fields-pro/',//plugin_basename( __FILE__ ),
			'path'				=> get_template_directory(__FILE__).'/admin/lib/advanced-custom-fields-pro/',//plugin_dir_path( __FILE__ ),
			'dir'				=> get_stylesheet_directory_uri(__FILE__).'/',//plugin_dir_url( __FILE__ ),
